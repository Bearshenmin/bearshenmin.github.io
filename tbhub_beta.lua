...
OtherSection:NewSection("TeddyBear Hub_beta")
OtherSection:NewSection("版本:0.3(全新改版)")
OtherSection:NewSection("copyright:TeddyBear 2023")
OtherSection:NewSection("yt頻道:雞排飯好吃(https://youtube.com/@bearshen1019)")
OtherSection:NewSection("https://bearshenmin.github.io")
OtherSection:NewSection("感謝你使用TeddyBear Hub_beta，祝你有個美好的一天。")